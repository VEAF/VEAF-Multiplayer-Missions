...
if veafCarrierOperations then
    ...
    -- start operations in a few seconds
    mist.scheduleFunction(veafCarrierOperations.startCarrierOperations,{{"CSG-74 Stennis", 90}},timer.getTime() + 10)
    mist.scheduleFunction(veafCarrierOperations.startCarrierOperations,{{"CSG-71 Roosevelt", 90}},timer.getTime() + 12)
    mist.scheduleFunction(veafCarrierOperations.startCarrierOperations,{{"CSG-01 Tarawa", 90}},timer.getTime() + 14)
end
