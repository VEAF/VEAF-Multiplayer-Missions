...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
veaf.config.MISSION_NAME = "Operation-Steel-Bayonet"
...
if veafCombatMission then 
    ...
    veafCombatMission.addCapMission("CAP-Novorossiysk-N", "CAP on Novorossiysk - NS", "A Russian CAP patrol has been spotted over Novorossiysk.", true, false)
    veafCombatMission.addCapMission("CAP-Novorossiysk-E", "CAP on Novorossiysk - EW", "A Russian CAP patrol has been spotted over Novorossiysk.", true, false)
