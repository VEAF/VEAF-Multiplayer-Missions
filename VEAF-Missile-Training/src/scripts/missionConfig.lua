...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
veaf.config.MISSION_NAME = "VEAF-Missile-Training"
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
-- initialize the Missile Trainer module in MOOSE
-------------------------------------------------------------------------------------------------------------------------------------------------------------

-- Tracing all methods in MOOSE 
-- BASE:TraceClass("MISSILETRAINER")
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
if (veafRadio) then
    local MISSION_MASTER_GROUPID = 3694
    local LOG_NAME = "MISSILETRAINER"
    ...
    local function setToAll(onOff)
        Trainer:InitAlertsToAll(onOff) 
        Trainer:InitTrackingToAll(onOff)
    end

    local function _respawnGroup(groupName)
